...
public class PropertyReader {
	...
	*/
	private void loadProperties() {
		try {
			inputStream = new FileInputStream("./src/com/spring/hibernate/resources/config.properties");
			properties.load(inputStream);
		} catch (IOException e) {
			setLogger().error("[PropertyReader : loadProperties] Exception thrown -- " + Utilities.getStackTrace(e));
